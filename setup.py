...
setuptools.setup(name='pinner',
    ...
    install_requires=['stopit>=1.1.2', 'posix-ipc>=1.0.4', 'pycryptodome==3.6.1', 'eth-abi>=0.5.0', 'eth-utils>=0.7.4', 'jsonrpc-requests>=0.4.0', 'base58==1.0.0', 'ipfsapi==0.4.2.post1'],
    license='GPLv3',
    zip_safe=False,
